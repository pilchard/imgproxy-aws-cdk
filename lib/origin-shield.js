...
var REGION_TO_ORIGIN_SHIELD_MAPPINGS = new Map([
...
var getOriginShieldRegion = function (region) {
    var originShieldRegion = REGION_TO_ORIGIN_SHIELD_MAPPINGS.get(region);
    if (originShieldRegion === undefined) {
        throw new Error("The specified region ".concat(region, " is not supported."));
    }
